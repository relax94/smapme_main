...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.MyViewHolder> {
    ...
    private List<ImageEventModel> images;
    ...
    public GalleryAdapter(Context context, List<ImageEventModel> images) {
        mContext = context;
        this.images = images;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        ImageLoader.loadImage(mContext, holder.thumbnail,
                Constants.PATH_TO_EVENTS_IMAGES + Constants.IMAGE_SIZES.get(ImageSizes.SMALL) +
                image.getPhotoName());
    }
